...
def populate(d):
    ...
    d.project_name = "pdmt"
    d.project_website = f"https://{project_github_username}.github.io/{project_name}"
    d.project_website_source = f"https://github.com/{project_github_username}/{project_name}"
    d.project_website_git = f"git://github.com/{project_github_username}/{project_name}.git"
    ...
    d.project_md_description = f"""* pdmt is influenced by scons but also very different from scons.
